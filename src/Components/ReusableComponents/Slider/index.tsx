...
// const labl = ['72', '48', '24', '12', 'Activity\nTime'];
      ...
      <>
        {renderAboveThumbComponent && (
          <View style={styles.aboveThumbComponentsContainer}>
            {interpolatedThumbValues.map((interpolationValue, i) => {
              ...
              return (
                <Animated.View
                  key={`slider-above-thumb-${Math.random(1, 36)}`}
                  style={[
        ...
        <View
          ...
          {renderTrackMarkComponent &&
            ...
            interpolatedTrackMarksValues.map((value, i) => {
              return (
                <>
                  <Animated.View
                    key={`track-mark-${Math.random(1, 36)}`}
                    style={[
                      styles.renderThumbComponent,
                      {
                        ...
                        marginLeft: i == 4 ? 0 : label?.length == 3 ? -11 : 3,
                        ...valueVisibleStyle,
                      },
                    ]}>
                    <Text
          ...
          {interpolatedThumbValues.map((value, i) => (
            <Animated.View
              key={`slider-thumb-${Math.random(1, 36)}`}
              style={[
                renderThumbComponent
                  ? styles.renderThumbComponent
                  : styles.thumb,
          ...
          <View style={styles.belowThumbComponentsContainer}>
            {interpolatedThumbValues.map((interpolationValue, i) => {
              ...
              return (
                <>
                  <Animated.View
                    key={`slider-below-thumb-${Math.random(1, 36)}`}
                    style={[
                      styles.renderThumbComponent, // eslint-disable-next-line react-native/no-inline-styles
                      {
                        top: 0,
                        ...
                        width:
                          value > 10
                            ? JSON.parse(JSON.stringify(interpolationValue)) +
                              20
                            : 0,
                  ...
                  <Animated.View
                    ...
                    {value < 50 ? (
                      <Text variant="primary12500" pt="t">
                        no refund
                      </Text>
                    ) : (
                      <Text variant="primary12500" pt="t"></Text>
                    )}
                  </Animated.View>
                </>
              );
