...
import {Text, Box, TouchableBox} from '../../../Theme/Index';
    ...
    return (
      <View style={styles.paginationContainer}>
        <SafeAreaView>
          ...
          {primaryButton}
          {secondaryButton}
          <Box pt="s" alignSelf={'center'} alignItems="center">
            <Text variant={'white14400'}>
              Already have an account?{' '}
              {/* <TouchableBox onPress={this.props.onLogin}> */}
              <Text
                variant="white14400"
